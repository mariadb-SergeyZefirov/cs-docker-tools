...
CREATE TABLE IF NOT EXISTS texts (num_delims INTEGER NOT NULL, text_line TEXT NOT NULL);
...
CREATE TABLE IF NOT EXISTS text_parts (text_part TEXT NOT NULL);
...
INSERT INTO text_parts (text_part) VALUES ("bigger than thirteen chars");
INSERT INTO text_parts (text_part) VALUES ("but less than one hundred eighty eight chars long");
...
INSERT INTO texts (num_delims, text_line)
    ...
    WHERE T0.text_part <> T1.text_part AND T1.text_part <> T2.text_part AND T2.text_part <> T3.text_part;
